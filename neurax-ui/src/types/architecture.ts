export type LayerType =
  ...
  // MoE — composite
  | 'moe_layer'
  // Diffusion — architecture blocks added by templates
  | 'unet_encoder'
  | 'unet_decoder'
  | 'unet_mid'
  | 'unet_latent'
  ...
  | 'discriminator'
  | 'synthesis_block'
  | 'cyclegan_block_as_resblock'
  | 'biggan_res_block_as_gen'
  | 'progan_block'
  | 'self_attention'
  // SSM — additional block types
  | 'mamba_block'
  | 'mamba_ssm'
  | 'ssm_block_operator'
  | 'ssd_block'
  // Linear / dense aliases
  | 'linear'
  // Pooling aliases
  | 'maxpool'
  | 'global_avg_pool';
