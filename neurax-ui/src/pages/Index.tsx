...
const initialAnalysis: AnalysisResult = {
  ...
  flopsPerToken: 0, arithmeticIntensity: 0, bottleneck: '', rooflinePosition: 0,
  ...
  const handleRunAnalysis = useCallback(async () => {
    ...
    try {
      ...
      setAnalysis({
        ...
        pipelineStages: parallelism.pipeline_parallel ?? 1,
        tensorParallelDegree: parallelism.tensor_parallel ?? 1,
